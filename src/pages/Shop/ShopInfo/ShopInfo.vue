  ...
  <div class="shop-info">
    <div class="info-content">
      ...
      <section class="section">
        ...
        <div class="activity">
          <div class="activity-item activity-green" v-for="(support, index) in info.supports" :key="index" :class="supportClasses[support.type]">
      ...
      <section class="section">
        ...
        <ul class="detail">
          <li><span class="bold">品类</span> <span>{{info.categorys}}</span></li>
